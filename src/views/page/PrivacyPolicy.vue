<template>
	<div class="card">
		<div class="card-content">
			...
			<p>
				As a guest, the Memphis ARTCC does not collect any data about you, except:
			...
			<p>
				As a member, the Memphis ARTCC collects, in addition to the points above, some personal information about you and your usage of our website, for example:
				<ul class="browser-default">
