						...
						<tr v-for="controller in controllersFiltered" :key="controller.cid">
							...
							<div :id="`modal_delete_${controller.cid}`" class="modal modal_delete">
								<div class="modal-content">
									...
									<p>This will remove <b>{{controller.fname}} {{controller.lname}}</b> from the Memphis ARTCC. You must state a reason for removal below. Please note that this will delete the controller from both the website and the VATUSA facility roster.</p>
