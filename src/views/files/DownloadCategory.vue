<template>
	<div :id="cat" class="col s12">
		...
		<div class="download" v-else v-for="file in files" :key="file.id">
			<a :href="`https://memphis-artcc.nyc3.digitaloceanspaces.com/downloads/${file.fileName}`" target="_blank" class="btn button"><i class="material-icons">file_download</i></a>
