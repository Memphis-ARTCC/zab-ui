<template>
	<div class="card event_card">
		...
		<div class="event" v-else>
			<img :src="`${event.bannerUrl.match(/^http/) ? event.bannerUrl : `https://memphis-artcc.nyc3.digitaloceanspaces.com/events/${event.bannerUrl}`}`" class="event_banner" draggable="false" alt="" />
